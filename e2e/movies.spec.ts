...
test.describe("main page", () => {
  ...
  test('first movie title should be "A new Hope" ', async ({ page }) => {
    await page.goto("/");
    const firsrtMovieTitle = page
      .getByTestId("movies-item-4")
      .getByTestId("movie-title");
...
test.describe("the movie page", () => {
  ...
  test('click on "star wars" should lead to the main page', async ({
    page,
  }) => {
    await page.goto("/movies/2");
